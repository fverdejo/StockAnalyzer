...
**Auditoria agregada (`auditor-estadistico`):** contando solo la familia de tests con la metrica estandar del proyecto (t pareado por fecha via `runCrossSectional()`) sobre esta UNA variable subyacente a lo largo de cuatro rondas -- invertir el flag (`2026-08-21`, 18 combinaciones), rampa continua v1 (`2026-08-22`, 20), piloto solo-`healthcare` (`2026-08-22`, 10: dos variantes x 5 horizontes, cifra corregida de 8 a 10 respecto al resumen inicial) y rampa continua v2 (hoy, 24) -- se acumulan **72 comparaciones independientes**. De esas 72, exactamente **1** cruza |t|>=1,96: menos de los **3,6 falsos positivos que el puro azar predice** en 72 pruebas al 5% nominal, y ademas en el sentido contrario al buscado. Ningun umbral razonable (Bonferroni acumulado ≈3,4-3,5, o Benjamini-Hochberg sobre las 72) rescata ese unico resultado.
