...
class IndicatorEducation
{
    ...
    private static function expand(Signal $signal): string
    {
        return match ($signal->getLabel()) {
            'Precio vs SMA20', 'Precio vs SMA50' => 'La comparación entre precio y medias móviles resume si la acción cotiza por encima o por debajo de su tendencia reciente.',
            ...
            'RSI', 'RSI (14)' => 'El RSI ayuda a detectar si el movimiento reciente está demasiado estirado. No decide solo, pero evita comprar impulsos agotados o vender caídas ya extremas.',
            ...
            'Bandas de Bollinger' => 'Las bandas muestran si el precio está cerca de extremos estadísticos recientes. Eso puede indicar presión excesiva o una ruptura fuerte.',
            ...
            'Rango medio diario (ATR)', 'ATR (14)' => 'ATR aproxima cuánto se mueve la acción cada día. Un ATR alto no es malo por sí mismo, pero aumenta el riesgo de entrada.',
            'Volatilidad 20 dias', 'Volatilidad 20d' => 'La volatilidad mide cuánto varía el precio día a día. Cuanto mayor, más riesgo (y más rango de movimiento posible) en poco tiempo.',
            ...
            'Margen neto', 'Margen operativo' => 'Los márgenes fundamentales indican qué porcentaje de cada venta se queda la empresa como beneficio. Márgenes altos y estables suelen reflejar ventaja competitiva.',
