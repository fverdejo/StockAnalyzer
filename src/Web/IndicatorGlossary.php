...
class IndicatorGlossary
{
    ...
    private const LONG_EXPLANATIONS = [
        ...
        'Sesiones analizadas' => 'Numero de velas historicas realmente disponibles para calcular el resto de indicadores tecnicos. Sirve para saber cuanta confianza dar al resto de valores: con pocas sesiones (empresa que cotiza poco tiempo, o historico incompleto), indicadores como la SMA50 o el maximo/minimo de periodo son menos representativos.',
