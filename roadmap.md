...
**Siguiente y ultimo punto del plan de Codex**: `P3.3` (conectar `RelativeFundamentalScorer` al backtest transversal con los 628 tickers — primera vez que la muestra cumple `MIN_PEERS=8`, prioridad de `inversor-fundamental`, requiere trabajo de `desarrollador-php` primero: el scorer no esta conectado al backtest transversal hoy). No iniciado.
