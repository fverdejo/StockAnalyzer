...
**Puntos 1, 2 y 3 implementados y verificados el `2026-09-02`** (`BacktestingService.php`, detalle completo con las 27 roturas de test arregladas y los 4 tests nuevos que fijan el criterio de cada arreglo en `versions.md`, entrada "quinta entrada" del `2026-09-02`): 493 tests/1.351 assertions en verde, PHPStan sin errores. Queda pendiente el punto 4 (repetir el baseline), a la espera de confirmacion del usuario por ser una medicion cara sobre los 636 tickers.
