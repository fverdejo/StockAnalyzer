...
- Pendiente, sin empezar: Bloque C (modelo de datos normalizado: `fiscal_periods`/`earnings_events`/`estimate_trends`/`corporate_actions`) y Bloque E (experimentos E1/E2/E3, ver el veredicto de `auditor-estadistico` del `2026-09-05` sobre cual de los tres tiene sentido medir todavia dado lo que Codex ya probo).
